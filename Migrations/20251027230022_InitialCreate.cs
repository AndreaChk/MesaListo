        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    RestauranteID = table.Column<string>(type: "text", nullable: false)
                },
                constraints: table =>
                {
                    table.PrimaryKey("PK_Mesas", x => x.MesaID);
                    table.ForeignKey(
                        name: "FK_Mesas_AspNetUsers_RestauranteID",
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ReseniaID = table.Column<int>(type: "integer", nullable: false)
                        .Annotation("Npgsql:ValueGenerationStrategy", NpgsqlValueGenerationStrategy.IdentityByDefaultColumn),
                    Calificacion = table.Column<int>(type: "integer", nullable: false),
                    Comentario = table.Column<string>(type: "character varying(500)", maxLength: 500, nullable: false),
                    FechaResenia = table.Column<DateTime>(type: "timestamp with time zone", nullable: false),
                    ReservaID = table.Column<int>(type: "integer", nullable: false),
                    ClienteID = table.Column<string>(type: "text", nullable: false)
                },
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_Resenias_AspNetUsers_ClienteID",
                        column: x => x.ClienteID,
                        principalTable: "AspNetUsers",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Restrict);
                    table.ForeignKey(
                        name: "FK_Resenias_Reservas_ReservaID",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_Resenias_ClienteID",
                table: "Resenias",
                column: "ClienteID");

            migrationBuilder.CreateIndex(
                name: "IX_Resenias_ReservaID",
                table: "Resenias",
                column: "ReservaID",
                unique: true);
